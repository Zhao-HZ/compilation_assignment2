...
# Example 1: checks if a 01-string has an odd number of 1s.
states1 = {"q0", "q1"}
initialState1 = "q0"
finalStates1 = {"q1"}
alphabet1 = {"0", "1"}
...
# Example 2: checks if a 01-string has an even number of 0s.
states2 = {"q0", "q1"}
initialState2 = "q0"
finalStates2 = {"q0"}
alphabet2 = {"0", "1"}
...
# Example 3: checks if a 01-string has an even number of 0s and an even nmber of 1s.
states3 = {"q0", "q1", "q2", "q3"}
initialState3 ="q0"
finalStates3 = {"q0"}
alphabet3 = {"0", "1"}
...
# Example 4: checks if a 01-string ends with 01 and does not contain 11 as a substring.
...
if __name__ == '__main__':
    ...
    print("DFAmore")
    exmore_strs = ["00", "101010", "0", "111", "1", "01"]
    for str in exmore_strs:
        print(str, end="")
        print(" is accepted" if dfa_more.accepts(str) else " is not accepted")
